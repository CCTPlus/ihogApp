...
extension SFSymbol {
    ...
    static let NO_SHAPE_ICONS = Self.allCases.filter {!$0.name.hasSuffix("fill")}.filter {!$0.name.hasSuffix("circle")}.filter {!$0.name.hasSuffix("square")}.filter { !$0.name.contains("badge")}
}
