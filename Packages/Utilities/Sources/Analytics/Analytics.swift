...
public class Analytics {
  ...
  public func logEvent(with event: AnalyticEvent, parameters: [AnalyticEventParameter: Any] = [:]) {
  ...
  public func logError(with error: Error, for logCategory: LogCategory, level: ErrorLevel) {
  ...
  public func logPurchase(transacion: Transaction) {
